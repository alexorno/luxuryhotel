...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // roomDetailsName[0].addEventListener('click', function () {
    //     roomDetail[0].classList.toggle('active');
    // });
    // roomDetailsName[1].addEventListener('click', function () {
    //     roomDetail[1].classList.toggle('active');
    // });
    // roomDetailsName[2].addEventListener('click', function () {
    //     roomDetail[2].classList.toggle('active');
    // });
